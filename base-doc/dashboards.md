...
This interface is used to duplicate a new dashboard from an existing dashboard.

## Request

Facts | &nbsp;
---|---
HTTP URL | https://fsopen.bytedance.net/open-apis/bitable/v1/apps/:app_token/dashboards/:block_id/copy
HTTP Method | POST
...
---|---|---
app_token | string | Base App Token<br>**Example value**: "basbcldP5xZeskcHDFZQfeToydb"
block_id | string | Base block_id<br>**Example value**: "blkEsvEEaNllY2UV"

### Request body

Parameter | Type | Required | Description
---|---|---|---
name | string | Yes | Dashboard Name<br>**Example value**: "Dashboard"
...
400 | 1254032 | Invalid role name, make sure that it complies with the specification. | Invalid role name
400 | 1254033 | Duplicated role name, use another name instead. | Role name duplicated
400 | 1254036 | Base is copying, please try again later. | Base copy replicating, try again later
400 | 1254038 | Invalid name, make sure that it complies with the specification. | The name is irregular, the name cannot contain "[]" and cannot exceed 100 characters
400 | 1254039 | Duplicated name, use another name instead. | The name is duplicate with the existing dashboard name, try again after changing the name
...
404 | 1254050 | Source block is not found. | Passed in a non-existent dashboard block_id
